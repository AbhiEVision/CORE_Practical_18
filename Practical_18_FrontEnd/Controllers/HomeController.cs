...
namespace Practical_18_FrontEnd.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> Create(CreateModel model)
		{
			...
			var result = await _httpClient.PostAsJsonAsync("https://localhost:7067/api/Student", model);
		...
		{
			string url = "https://localhost:7067/api/Student/" + id.ToString();
		...
		{
			string url = "https://localhost:7067/api/Student/" + model.Id.ToString();
